...
// they throw `Error('Not implemented yet')` until the backend ships.
// The handlers below catch that throw and surface a friendly
// "belum tersedia" message — no client-side simulation, no dummy code.
...
export default function ForgotPassword() {
    ...
    // Reset token returned by authApi.verifyOtp on success — passed to
    // authApi.resetPassword on step 4. Held in a ref because it's only
    // read inside the next handler, never rendered.
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            // authApi.verifyOtp is a STUB until backend ships — throws
            // 'Not implemented yet'. The catch below surfaces a friendly notice.
            const data = await authApi.verifyOtp({ phone, otp: entered });
            resetTokenRef.current = data?.reset_token ?? null;
            setOtpError("");
            setOtpVerifying(false);
            setStep(4);
        } catch (err) {
            const msg = (err && err.message === 'Not implemented yet')
                ? 'Fitur reset password akan tersedia setelah backend siap.'
                : extractError(err, 'Kode OTP salah. Coba lagi.');
            setOtpError(msg);
            setOtpVerifying(false);
    ...
    const handleSavePassword = async () => {
        ...
        setSaving(true);
        try {
            // authApi.resetPassword is a STUB until backend ships.
            ...
            const msg = (err && err.message === 'Not implemented yet')
                ? 'Fitur reset password akan tersedia setelah backend siap.'
                : extractError(err, 'Gagal menyimpan password baru.');
            setPassError(msg);
            setSaving(false);
        }
    };
    ...
    const strengthColor = ["", "#B87272", "#C4A24D", "#C4A24D", "#7A9B6A", "#7a8a52"][strength] || "";
        ...
        <div className="fp-root">
            ...
            <div className="fp-wrapper">
                ...
                <div className="fp-brand">
                    <img src={logo} alt="Peken Banyumasan" className="fp-brand-logo peken" />
                </div>
                ...
                <div className="fp-card" key={step}>
                    ...
                    {step === 1 && (
                        <>
                            ...
                            <p className="fp-desc">
                                Masukkan nomor HP yang terdaftar pada akun kolaboratormu. Admin akan mengirimkan kode OTP melalui WhatsApp.
                            </p>
                            ...
                            <div className="fp-field">
                                ...
                                <p className="fp-hint">
                                    Gunakan nomor HP yang kamu daftarkan saat membuat akun kolaborator.
                                </p>
                            </div>
                        ...
                        <>
                            ...
                            <div className="fp-wa-card">
                                ...
                                <div className="fp-wa-bubble">
                                    <span>Halo Admin, saya ingin reset password akun kolaborator saya.</span>
                        ...
                        <>
                            {done ? (
                                ...
                                <div className="fp-success">
                                    ...
                                    <p className="fp-desc">
                                        Password akun kolaboratormu sudah diperbarui. Kamu akan diarahkan ke halaman login secara otomatis.
                                    </p>
                                ...
                                <>
                                    ...
                                    <p className="fp-desc">
                                        Buat password baru yang kuat untuk mengamankan akun kolaboratormu.
                                    </p>

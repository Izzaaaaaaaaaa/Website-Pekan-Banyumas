...
export const PROFILES = [
  {
    ...
    kota: 'Banyumas', verified: true, foto_url: null, cover_url: null,
    ...
    karya: [
      { id: 'k1', judul: 'Senja di Pasar Lama', gambar_url: '/assets/gallery-1.jpg', subsektor: 'Fotografi', tahun: '2026', deskripsi: 'Seri foto malam di kawasan Pasar Lama Banyumas. Diambil dengan kamera analog format 35mm.' },
      { id: 'k2', judul: 'Wajah-Wajah Peken', gambar_url: '/assets/gallery-perform-1.jpg', subsektor: 'Fotografi', tahun: '2025', deskripsi: 'Potret para pedagang dan pengunjung Peken dalam momen kebersamaan yang autentik.' },
      { id: 'k3', judul: 'Ritual Panggung #47', gambar_url: '/assets/gallery-perform-2.jpg', subsektor: 'Fotografi', tahun: '2025', deskripsi: 'Dokumentasi pertunjukan Pitutur Banyumasan edisi ke-47 di Taman Sari.' },
    ],
    story: [
  ...
  },
  {
    ...
    kota: 'Sokaraja, Banyumas', verified: true, foto_url: null, cover_url: null,
    ...
    karya: [
      { id: 'k1', judul: 'Tenun Lurik Modular', gambar_url: '/assets/gallery-2.jpg', subsektor: 'Tekstil', tahun: '2025', deskripsi: 'Eksperimen tenun lurik dengan modul lebar tetap untuk memudahkan kombinasi warna oleh desainer pakaian.' },
      { id: 'k2', judul: 'Lurik Diagonal Cilacap', gambar_url: '/assets/banner-home-1.jpg', subsektor: 'Tekstil', tahun: '2024', deskripsi: 'Koleksi tenun lurik dengan pola diagonal hasil kolaborasi dengan pengrajin Cilacap.' },
    ],
    story: [
  ...
  },
  {
    ...
    karya: [
      { id: 'k1', judul: 'Edisi #54 — Geguritan Malam', gambar_url: '/assets/gallery-3.jpg', subsektor: 'Seni Pertunjukan', tahun: '2025', deskripsi: 'Dokumentasi panggung geguritan malam pada Peken Edisi #54.' },
      { id: 'k2', judul: 'Kidung Banyumasan #39', gambar_url: '/assets/gallery-perform-2.jpg', subsektor: 'Seni Pertunjukan', tahun: '2024', deskripsi: 'Penampilan kidung Banyumasan dipandu dalang muda dari Kecamatan Sokaraja.' },
    ],
    story: [
  ...
  },
  {
    ...
    kota: 'Purwokerto, Banyumas', verified: true, foto_url: null, cover_url: null,
    ...
    karya: [
      { id: 'k1', judul: 'Banyumasan Streetwear Cap.1', gambar_url: '/assets/program-fashion.jpg', subsektor: 'Mode', tahun: '2025', deskripsi: 'Lini streetwear pertama dari Reka Studio yang mengadaptasi motif batik banyumasan.' },
    ],
    story: [
  ...
  },
  {
    ...
    karya: [
      { id: 'k1', judul: 'Wadah Bambu Lipat', gambar_url: '/assets/gallery-4.jpg', subsektor: 'Kriya', tahun: '2024', deskripsi: 'Wadah makanan bambu lipat untuk mendukung Bring Your Own Bowl.' },
    ],
    story: [
  ...
  },
  {
    ...
    karya: [
      { id: 'k1', judul: 'Mural Kota Lama', gambar_url: '/assets/gallery-5.jpg', subsektor: 'Seni Publik', tahun: '2024', deskripsi: 'Mural permanen pada dinding selatan Taman Sari, dilukis selama dua minggu.' },
    ],
    story: [
  ...
  },
  {
    ...
    kota: 'Baturraden, Banyumas', verified: true, foto_url: null, cover_url: null,
    ...
    karya: [
      { id: 'k1', judul: 'Kopi Robusta Banyumas', gambar_url: '/assets/program-coffee.jpg', subsektor: 'Kuliner', tahun: '2024', deskripsi: 'Robusta single-origin dari ketinggian 800 mdpl di Baturraden.' },
    ],
    story: [
  ...
  },
  {
    ...
    karya: [
      { id: 'k1', judul: 'Aksara Jawa Banyumasan', gambar_url: '/assets/gallery-6.jpg', subsektor: 'Desain Grafis', tahun: '2023', deskripsi: 'Tipografi aksara Jawa varian Banyumasan, dirilis sebagai font terbuka.' },
    ],
    story: [
  ...
  },
  {
    ...
    kota: 'Desa Banjarsari, Banyumas', verified: false, foto_url: null, cover_url: null,
    ...
    karya: [
      { id: 'k1', judul: 'Anyaman Pandan Modular', gambar_url: '/assets/gallery-perform-1.jpg', subsektor: 'Kriya', tahun: '2023', deskripsi: 'Anyaman pandan modular yang bisa dirangkai menjadi tas, alas duduk, atau partisi ruang.' },
    ],
    story: [

  ...
  return (
    <>
      <button type="button" onClick={() => setOpen(true)}
        className={`flex items-center gap-1.5 px-2 py-1.5 rounded-lg border text-xs font-medium transition whitespace-nowrap ${value ? 'border-[#c8d09a] bg-[#eef0e0] text-[#7a8a52] hover:bg-[#eef4eb]'
                      ...
                      return (
                        <div key={req.id} className="py-1">
                          <div
                            ...
                            <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold border shrink-0 ${isPending ? 'bg-[#fef9c3] text-[#854d0e] border-yellow-200' :

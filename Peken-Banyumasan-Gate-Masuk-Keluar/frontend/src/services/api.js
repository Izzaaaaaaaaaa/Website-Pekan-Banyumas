...
function normalizeBaseUrl(url) {
  ...
  // e.g. "admin-production.up.railway.app" becomes
  // https://<pages-host>/admin-production.up.railway.app/api/... which, with the
  // SPA _redirects catch-all, returns index.html and crashes the app on JSON
